...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		map1 = new UnfoldingMap(this, 50, 50, 100, 100, provider);
		...
		map2 = new UnfoldingMap(this, 350, 50, 200, 100, provider2);

		// The next line zooms in and centers the map at 
	    // 32.9 (latitude) and -117.2 (longitude)
	    map2.zoomAndPanTo(zoomLevel, new Location(24.79f, 85.00f));
